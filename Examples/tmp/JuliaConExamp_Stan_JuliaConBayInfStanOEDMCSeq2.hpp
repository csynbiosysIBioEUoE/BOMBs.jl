...
namespace JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "e:/UNI/D_Drive/PhD/Year_1/2022_06_23_JuliaCon2022/tmp/JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2.stan");
    reader.add_event(195, 193, "end", "e:/UNI/D_Drive/PhD/Year_1/2022_06_23_JuliaCon2022/tmp/JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2.stan");
    return reader;
}
...
class JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model
  : public stan::model::model_base_crtp<JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model> {
private:
        int m;
        int stslm;
...
public:
    JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model_namespace::JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model";
    ...
    ~JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        n1 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(n1);
        } catch (const std::exception& e) {
        ...
        KM2 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(KM2);
        } catch (const std::exception& e) {
        ...
        d2 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(d2);
        } catch (const std::exception& e) {
        ...
        km = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(km);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            (void) n1;  // dummy to suppress unused var warning
            if (jacobian__)
                n1 = in__.scalar_constrain(lp__);
            else
                n1 = in__.scalar_constrain();

            current_statement_begin__ = 99;
            local_scalar_t__ KM2;
            (void) KM2;  // dummy to suppress unused var warning
            if (jacobian__)
                KM2 = in__.scalar_constrain(lp__);
            else
                KM2 = in__.scalar_constrain();

            current_statement_begin__ = 100;
            local_scalar_t__ d2;
            (void) d2;  // dummy to suppress unused var warning
            if (jacobian__)
                d2 = in__.scalar_constrain(lp__);
            else
                d2 = in__.scalar_constrain();

            current_statement_begin__ = 101;
            local_scalar_t__ km;
            (void) km;  // dummy to suppress unused var warning
            if (jacobian__)
                km = in__.scalar_constrain(lp__);
            else
                km = in__.scalar_constrain();
            ...
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        stan::math::exp(((n1 * 0.04143871887549682) + 1.1197892379138183)), 
                        "assigning variable theta");
            current_statement_begin__ = 112;
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                        ((KM2 * 6.389203819134893) + 15.683296447500005), 
                        "assigning variable theta");
            current_statement_begin__ = 113;
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_uni(3), stan::model::nil_index_list()), 
                        stan::math::exp(((d2 * 0.041890435442655666) + -(0.23346539422180088))), 
                        "assigning variable theta");
            current_statement_begin__ = 114;
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_uni(4), stan::model::nil_index_list()), 
                        stan::math::exp(((km * 0.047232512131290254) + 1.0962967683697238)), 
                        "assigning variable theta");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning

        // read-transform, write parameters
        double n1 = in__.scalar_constrain();
        vars__.push_back(n1);

        double KM2 = in__.scalar_constrain();
        vars__.push_back(KM2);

        double d2 = in__.scalar_constrain();
        vars__.push_back(d2);

        double km = in__.scalar_constrain();
        vars__.push_back(km);
    ...
    std::string model_name() const {
        return "JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model";
    }
...
typedef JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model_namespace::JuliaConExamp_Stan_JuliaConBayInfStanOEDMCSeq2_model stan_model;
