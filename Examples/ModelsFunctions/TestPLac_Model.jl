    ...
    using ODEInterfaceDiffEq
        ...
        function TestPLacSteadyState(p,I)
        ...
        function TestPLac_solvecoupledODE(ts, p, sp, inputs, ivss, pre=[])
            ...
            y_al = TestPLacSteadyState(pSS,ivss) # Calculation of initial guesses for steady state
            ...
            for q in collect(1:Nevents)
                ...
                if q == 1
                    prob = ODEProblem(TestPLacODE!,initialV,(ts[(sp[q]+1)],ts[sp[q+1]+1]),pSte);
        ...
        function TestPLac_SolveAll(ts, pD, sp, inputs, ivss, samps, pre=[])
            ...
            for drawInd in collect(1:length(pD[:,1]))
                ...
                temp = TestPLac_solvecoupledODE(ts, p, sp, inputs, ivss2, pre);
